...
void husExpand(unsigned char *input, unsigned char *output, int compressedSize,
  ...
  if (_166)
    memset(_166, 0, (_175 + 2) * sizeof(unsigned char));
  _240 = (unsigned short *)malloc(sizeof(unsigned short) * (_148));
  if (_240)
    memset(_240, 0, (_148) * sizeof(unsigned short));
  _241 = (unsigned short *)malloc(sizeof(unsigned short) * (_149));
  if (_241)
    memset(_241, 0, (_149) * sizeof(unsigned short));
  _189 = (unsigned short *)malloc(sizeof(unsigned short) * (2 * _141 - 1));
  if (_189)
    memset(_189, 0, (2 * _141 - 1) * sizeof(unsigned short));
  _190 = (unsigned short *)malloc(sizeof(unsigned short) * (2 * _141 - 1));
  if (_190)
    memset(_190, 0, (2 * _141 - 1) * sizeof(unsigned short));
  _180 = (unsigned char *)malloc(sizeof(unsigned char) * (_141));
  if (_180)
    memset(_180, 0, (_141) * sizeof(unsigned char));
  _181 = (unsigned char *)malloc(sizeof(unsigned char) * (_152));
  if (_181)
    memset(_181, 0, (_152) * sizeof(unsigned char));

  if (_166 == NULL || _189 == NULL || _190 == NULL || _180 == NULL ||
      _181 == NULL || _240 == NULL || _241 == NULL || inputBuffer == NULL) {
    mStatus = -1;
  }
...
void husExpand_258(int _259, unsigned char *_260, int _261,
                   unsigned short *_262, unsigned short _263) {
...
int husCompress(unsigned char *_266, unsigned long _inputSize,
                unsigned char *_267, int _269, int _235) {
  int returnVal;
  inputArray = _266;
  outputArray = _267;
  _531 = _235;
  ...
  if (_166)
    memset(_166, 0, (_175 + _140 + 2) * sizeof(unsigned char));
  _163 = (short *)malloc(sizeof(short) * (_175 + _153));
  if (_163)
    memset(_163, 0, (_175 + _153) * sizeof(short));
  _164 = (short *)malloc(sizeof(short) * (_175));
  if (_164)
    memset(_164, 0, (_175) * sizeof(short));
  _165 = (unsigned char *)malloc(sizeof(unsigned char) * (_155));
  if (_165)
    memset(_165, 0, (_155) * sizeof(unsigned char));
  _179 = (unsigned char *)malloc(sizeof(unsigned char) * (_156));
  if (_179)
    memset(_179, 0, (_156) * sizeof(unsigned char));
  _189 = (unsigned short *)malloc(sizeof(unsigned short) * (2 * _141 - 1));
  if (_189)
    memset(_189, 0, (2 * _141 - 1) * sizeof(unsigned short));
  _190 = (unsigned short *)malloc(sizeof(unsigned short) * (2 * _141 - 1));
...
void husCompress_223(short _203) { husCompress_208(_180[_203], _192[_203]); }
...
int husCompress_211(int _212, unsigned short *_213, unsigned char *_214,
                    unsigned short *_215) {
