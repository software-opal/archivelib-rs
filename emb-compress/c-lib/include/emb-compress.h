 ...
 ****************************************/
extern EMB_PRIVATE void EMB_CALL husExpand_258(int _259, unsigned char *_260,
                                               int _261, unsigned short *_262,
                                               unsigned short _263);
...
extern EMB_PRIVATE void EMB_CALL husExpand_253(short _254, short _220,
                                               short _221);
...
extern EMB_PRIVATE void EMB_CALL husCompress_202(unsigned short _203,
                                                 unsigned short _204);
...
extern EMB_PRIVATE int EMB_CALL husCompress_211(int _212, unsigned short *_213,
                                                unsigned char *_214,
                                                unsigned short *_215);
extern EMB_PRIVATE void EMB_CALL husCompress_216(unsigned short *_217);
extern EMB_PRIVATE void EMB_CALL husCompress_218(short _219, short _220,
                                                 short _221);
...
extern EMB_PRIVATE void EMB_CALL husCompress_225(int _226, unsigned short *_187,
                                                 short *_177, short _227);
extern EMB_PRIVATE void EMB_CALL husCompress_228(int _229);
extern EMB_PRIVATE void EMB_CALL husCompress_230(int _219, unsigned char *_209,
                                                 unsigned short *_231);
...
#define husCompress_445(_200, _446)                                            \
  ((short)((_446 << _154) ^ (_278[_200 + 2])) & (_153 - 1))
#define husCompress_447(_200, _201)                                            \
  {                                                                            \
    short _204;                                                                \
