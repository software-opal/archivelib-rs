...
void RExpand::fn258(int32_t _259, uint8_t *_260, int32_t _261, uint16_t *_262,
  ...
  uint run_start226, _289, _209, _290, _291, _292, _293, _283;
  for (run_start226 = 1; run_start226 <= 16; run_start226++)
    _277[run_start226] = 0;
  for (run_start226 = 0; (int32_t)run_start226 < _259; run_start226++)
    _277[_260[run_start226]]++;
  _288[1] = 0;
  for (run_start226 = 1; run_start226 <= 16; run_start226++)
    _288[run_start226 + 1] = (uint16_t)(_288[run_start226] + (_277[run_start226] << (16 - run_start226)));
