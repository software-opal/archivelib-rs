...
int32_t RCompress::Compress() {
  ...
  while (_209 > CONST__140 + 4 && !_170) {
    ...
    if (_168 < CONST__135) {
      ...
      _209 -= _168;
      _202((uint16_t)(_168 + (UCHAR_MAX + 1 - CONST__135)), _169);
      while (--_168 >= 0) {
        _447(_200, _201);
        _200++;
        _201 = (int16_t)(_445(_200, _201) + _279);
  ...
  if (!_170)
    _202(CONST__144 + (UCHAR_MAX + 1 - CONST__135), 0);
  _197();
  if (_170)
    _231 = 1;
  return _231;
...
void RCompress::_196() {
  ...
  for (_226 = 0; _226 < CONST__141; _226++)
    _191[_226] = 0;
  for (_226 = 0; _226 < CONST__142; _226++)
    _193[_226] = 0;
  _173 = 0;
  _205();
  _170 = 0;
...
void RCompress::_198() {
  ...
  _450 = &_163[_175];
  for (_226 = CONST__153; _226 > 0; _226--)
    *_450++ = CONST__157;
  _450 = _164;
...
void RCompress::_199(int16_t _200, int16_t _201) {
  ...
  while ((_204 = _163[_204]) != CONST__157) {
    ...
    if (_451[2] != _278[2])
      continue;
    for (_226 = 3; _226 < CONST__140; _226++)
...
void RCompress::_207() {
  ...
  _229 = _211(CONST__141, _191, _180, _192);
  _455 = _191[_229];
  _208(16, (uint16_t)_455);
  if (_229 >= CONST__141) {
    _216(_217);
    _229 = _211(CONST__145, _217, _181, _194);
    if (_229 >= CONST__145) {
      _218(CONST__145, CONST__147, 3);
    } else {
      _208(CONST__147, 0);
      _208(CONST__147, (uint16_t)_229);
    }
    _222();
  } else {
    _208(CONST__147, 0);
    _208(CONST__147, 0);
    _208(CONST__143, 0);
    _208(CONST__143, (uint16_t)_229);
  }
  _229 = _211(CONST__142, _193, _181, _194);
  if (_229 >= CONST__142) {
    _218(CONST__142, CONST__540, -1);
  } else {
    _208(CONST__540, 0);
    _208(CONST__540, (uint16_t)_229);
  }
  _454 = 0;
...
void RCompress::_216(uint16_t *_217) {
  ...
  for (_226 = 0; _226 < CONST__145; _226++)
    _217[_226] = 0;
  _219 = CONST__141;
  ...
  while (_226 < _219) {
    ...
    if (_289 == 0) {
      ...
      if (_277 <= 2) {
        ...
        _208(_181[2], _194[2]);
        _208(CONST__143, (uint16_t)(_277 - 20));
      }
    } else
