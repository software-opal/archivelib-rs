...
#define _445(_200, _446)                                                       \
  ((int16_t)((_446 << _154) ^ (_278[_200 + 2])) & (_153 - 1))
...
RCompress::RCompress(ALStorage &_266, ALStorage &_267, int32_t _269,
  ...
  if ((_190 = new uint16_t[2 * _141 - 1]) != 0)
    memset(_190, 0, (2 * _141 - 1) * sizeof(uint16_t));
  if ((_177 = new int16_t[_141 + 1]) != 0)
    memset(_177, 0, (_141 + 1) * sizeof(int16_t));
  _180 = new uint8_t[_141];
  if ((_191 = new uint16_t[2 * _141 - 1]) != 0)
    memset(_191, 0, (2 * _141 - 1) * sizeof(uint16_t));
  if ((_192 = new uint16_t[_141]) != 0)
    memset(_192, 0, _141 * sizeof(uint16_t));
  _181 = new uint8_t[_152];
  if ((_193 = new uint16_t[2 * _142 - 1]) != 0)
    memset(_193, 0, (2 * _142 - 1) * sizeof(uint16_t));
  if ((_194 = new uint16_t[_152]) != 0)
    memset(_194, 0, _152 * sizeof(uint16_t));
...
inline void RCompress::_223(int16_t _203) { _208(_180[_203], _192[_203]); }
int32_t RCompress::Compress() {
  ...
  _169 = 0;
  _168 = 0;
  _201 = (int16_t)(((_278[_200] << _154) ^ (_278[_200 + 1])) & (_153 - 1));
  ...
  while (_209 > _140 + 4 && !_170) {
    ...
    if (_168 < _135) {
      ...
      _209 -= _168;
      _202((uint16_t)(_168 + (UCHAR_MAX + 1 - _135)), _169);
      while (--_168 >= 0) {
        _447(_200, _201);
        _200++;
        _201 = (int16_t)(_445(_200, _201) + _279);
...
void RCompress::_199(int16_t _200, int16_t _201) {
...
void RCompress::_202(uint16_t _203, uint16_t _204) {
  if ((_185 >>= 1) == 0) {
    _185 = 1U << (CHAR_BIT - 1);
    if (_184 >= _183) {
      _207();
...
void RCompress::_207() {
  ...
  uint32_t _456 = 0;
  uint16_t _217[2 * _145 - 1];
  _229 = _211(_141, _191, _180, _192);
  _455 = _191[_229];
  _208(16, (uint16_t)_455);
  if (_229 >= _141) {
    _216(_217);
  ...
  for (_226 = 0; _226 < _455; _226++) {
    ...
    if (_456 & (1U << (CHAR_BIT - 1))) {
      _223((int16_t)(_165[_454++] + (1U << CHAR_BIT)));
      _289 = _165[_454++];
...
void RCompress::_208(int32_t _209, uint16_t _203) {
  _203 <<= _133 - _209;
...
int32_t RCompress::_211(int32_t _212, uint16_t *_213, uint8_t *_214,
                        uint16_t *_215) {
  ...
  do {
    ...
    if (_276 < _174)
      *_188++ = (uint16_t)_276;
    _289 = _292++;
    _187[_289] = (uint16_t)(_187[_226] + _187[_276]);
    _177[1] = (int16_t)_289;
    _225(1, _187, _177, _227);
    _189[_289] = (uint16_t)_226;
...
void RCompress::_216(uint16_t *_217) {
...
void RCompress::_218(int16_t _219, int16_t _220, int16_t _221) {
  int16_t _226, _289;
  ...
  while (_226 < _219) {
    ...
    if (_289 <= 6) {
      ...
      _208(_289 - 3, (uint16_t)(USHRT_MAX << 1));
    if (_226 == _221) {
      while (_226 < 6 && _181[_226] == 0)
        _226++;
      _208(2, (uint16_t)(_226 - 3));
    }
  }
}
void RCompress::_222() {
  ...
  while (_226 < _219) {
    ...
    if (_289 == 0) {
      ...
      if (_277 <= 2) {
        ...
        _208(_181[2], _194[2]);
        _208(_143, (uint16_t)(_277 - 20));
      }
    } else
      _208(_181[_289 + 2], _194[_289 + 2]);
  }
}
void RCompress::_224(uint16_t _204) {
  uint16_t _203, _457;
  _203 = 0;
  _457 = _204;
  while (_457) {
...
void RCompress::_225(int32_t _226, uint16_t *_187, int16_t *_177,
                     int16_t _227) {
  int32_t _276, _289;
  _289 = _177[_226];
  ...
  _177[_226] = (uint16_t)_289;
}
void RCompress::_228(int32_t _229) {
  int32_t _226, _289;
  uint32_t _458;
  ...
  while (_458 != (1U << 16)) {
    ...
    for (_226 = 15; _226 > 0; _226--) {
      if (_167[_226] != 0) {
        _167[_226]--;
        _167[_226 + 1] = (uint16_t)(_167[_226 + 1] + 2);
        break;
      }
    }
    _458--;
  ...
  for (_226 = 16; _226 > 0; _226--) {
    _289 = _167[_226];
    while (--_289 >= 0)
      _178[*_188++] = (uint8_t)_226;
  }
}
void RCompress::_230(int32_t _219, uint8_t *_209, uint16_t *_231) {
  int32_t _226;
  uint16_t _288[18];
  _288[1] = 0;
  for (_226 = 1; _226 <= 16; _226++)
    _288[_226 + 1] = (uint16_t)((_288[_226] + _167[_226]) << 1);
  for (_226 = 0; _226 < _219; _226++)
    _231[_226] = _288[_209[_226]]++;
}
void RCompress::_232(int32_t _226) {
  if (_226 < _174)
