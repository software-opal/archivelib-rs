...
ALErrors create_compress_data(RCompressData *data, ALStorage &in_storage,
                              ALStorage &out_storage, ALGreenleafCompressionLevels compression_level_enum,
  ...
  data->dat_arr179_len = CONST__156;
  data->dat_arr179 = (uint8_t *)calloc(data->dat_arr179_len, sizeof(uint8_t));
  ...
  if (!data->dat_arr163 || !data->dat_arr164 || !data->dat_arr165 || !data->dat_arr166 || !data->dat_arr179 || !data->dat_arr177 || !data->dat_arr180 || !data->dat_arr181 || !data->dat_arr189 || !data->dat_arr190 || !data->dat_arr191 || !data->dat_arr192 || !data->dat_arr193 || !data->dat_arr194) {
...
void free_compress_data(RCompressData *data) {
  ...
  if (data->dat_arr179) {
    free(data->dat_arr179);
    data->dat_arr179 = NULL;
  }
  if (data->dat_arr177) {
