...
impl<R: Read, W: Write> RCompressData<R, W> {
  pub fn finalise_compresson197(&mut self) {
  ...
  pub fn finalize_buffer206(&mut self) {
    if !self.uncompressible {
  ...
  pub fn write_bits_to_buffer(&mut self, bit_count209: u16, mut bits203: u16) {
    /*
  ...
  pub fn write_stored_bits_to_buffer(&mut self, arg203: i16) {
    /*
