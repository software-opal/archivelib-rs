test_match_sys_decompress! {
  // From crashes: id:000000,sig:06,src:000007,op:flip4,pos:1024
  data => hex!("
      ...
      09 66 11 C5 C0 C7 8F 2D  FD 37 75 DA F8 47 FF 0D  C4 D4 7A 24 66 66 27 5E  95 6B 52 C4 AD 46 F0 A2
